          ...
          volumes: [
            {
              ...
              order: 1,
              chapters: [
                { title: '第一章：军火库的烟', order: 1, function: 'hook', content: '天津军火库的大火刚灭，灰烬中还冒着青烟。陆川站在警戒线外，手里的调令已经被汗水浸湿。他本是来报到当文书的，不是来查案子的。但长官说："你会英文，你去。"', targetWords: 3000 },
                { title: '第二章：账本最后一页', order: 2, function: 'exposition', content: '账本在保险柜里，烧得只剩一半。陆川一页页翻过去，发现了一个规律——所有被烧毁的记录，都是同一年同一个月。', targetWords: 3000 },
                { title: '第三章：租界的另一面', order: 3, function: 'rising_action', content: '陆川拿着账本残页去天津英租界找线索。在维多利亚道的咖啡馆里，他见到了一个自称"商人"的日本人——山本一郎。', targetWords: 3000 },
                { title: '第四章：暗流涌动', order: 4, function: 'conflict', content: '山本提出用重金买下账本。陆川拒绝了。当晚，他的住处被人翻了个底朝天。账本不见了——但陆川已经全部背下来了。', targetWords: 3000 },
                { title: '第五章：奉天之约', order: 5, function: 'climax', content: '账本指向的最终目的地是奉天。陆川带着记忆中的账本内容踏上了北上的火车。他不知道，山本的人已经在奉天火车站布下了天罗地网。', targetWords: 4000 },
                { title: '第六章：军人的抉择', order: 6, function: 'resolution', content: '在奉天城外的军营里，陆川见到了账本真正的幕后人物。一个他从未想过会是敌人的中国人。最后的抉择摆在他面前——是保全自己，还是把真相公之于众。', targetWords: 3000 },
              ],
            },
          ],
        },
